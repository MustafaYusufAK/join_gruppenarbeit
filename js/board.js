...
let tasksDone = [];
let assignedToDiv, titleInput, descriptionInput, categorySelect, createdAtInput, subtaskInput, subtaskList, assigneeContainers, categoryColor, title, description, category, createdAt;
...
//     assignedToDiv = document.getElementById('assignedToList');
//     titleInput = document.getElementById('title');
//     descriptionInput = document.getElementById('description_text');
...
//     assigneeContainers = assignedToDiv.getElementsByClassName('assigneeContainer');
//     categoryColor = categorySelect ? categorySelect.querySelector('.categoryColor').style.backgroundColor : '';
//     title = titleInput.value;
//     description = descriptionInput.value;
//     category = categorySelect ? categorySelect.innerText : '';
...
function handleFilledFields(task) {
    ...
    // Reset the input fields and other elements
    // ...
